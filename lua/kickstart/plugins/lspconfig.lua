    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          local client = vim.lsp.get_client_by_id(event.data.client_id)
          if not vim.g.vscode and client and client_supports_method(client, vim.lsp.protocol.Methods.textDocument_documentHighlight, event.buf) then
      ...
      -- Advertise folding range capability for nvim-ufo
      ...
      require('mason-lspconfig').setup {
        ...
        handlers = {
          function(server_name)
            ...
            -- certain features of an LSP (for example, turning off formatting for a server)
